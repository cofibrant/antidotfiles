...
(defgroup doom-iro-theme nil
  "Options for doom-iro."
  :group 'doom-themes)

(defcustom doom-iro-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-iro-theme
  :type 'boolean)

(defcustom doom-iro-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-iro-theme
  :type '(choice integer boolean))

(defcustom doom-iro-dark-variant nil
...
(def-doom-theme doom-iro
  "Dark theme with bright colors."

  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-iro-dark-variant "hard") '("#1e1f21" "#1e1f21" nil))   ; bg0_h
          ((equal doom-iro-dark-variant "soft") '("#323232" "#323232" nil))   ; bg0_s
          (t                                        '("#373a41" "#373a41" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-iro-dark-variant "hard") '("#0d1011" "black" nil))     ; (self-defined)
          ((equal doom-iro-dark-variant "soft") '("#373a41" "#373a41" nil))   ; bg0
          (t                                        '("#1e1f21" "#1e1f21" nil)))) ; bg_h
   (bg-alt2    '("#575c67" "#575c67" "brown"      )) ; bg2 (for region, selection etc.)

   (base0      '("#0d1011" "black"   "black"      )) ; (self-defined)
   (base1      '("#1e1f21" "#1e1f21" "brightblack")) ; bg0_h
   (base2      '("#32353c" "#32353c" "brightblack")) ; bg0
   (base3      '("#373a41" "#373a41" "brightblack")) ; bg1
   (base4      '("#41454d" "#41454d" "brightblack")) ; bg3
   (base5      '("#4c515a" "#4c515a" "brightblack")) ; bg4
   (base6      '("#575c67" "#575c67" "brightblack")) ; gray
   (base7      '("#626874" "#626874" "brightblack")) ; fg2
   (base8      '("#f2f3f4" "#f2f3f4" "brightwhite")) ; fg0
   (fg         '("#d9dbdf" "#d9dbdf" "brightwhite")) ; fg/fg1
   (fg-alt     '("#c1c4cb" "#c1c4cb" "brightwhite")) ; fg2

   ;; Standardized official colours from iro
   (grey        '("#626874" "#575c67" "brightblack"))   ; gray
   (red         '("#fb4934" "#e74c3c" "red"))           ; bright-red
   (magenta     '("#d84231" "#d84231" "magenta"))       ; red
   (violet      '("#f95882" "#f95882" "brightmagenta")) ; bright-purple
   (orange      '("#fe8b2d" "#fe8b2d" "orange"))        ; bright-orange
   (yellow      '("#fcc01a" "#fcc01a" "yellow"))        ; bright-yellow
   (dark-yellow '("#fcba04" "#fcba04" "yellow"))        ; yellow
   (teal        '("#42d5f3" "#42d5f3" "green"))         ; bright-aqua
   (green       '("#84c940" "#84c940" "green"))         ; bright-green
   (dark-green  '("#78c42d" "#78c42d" "green"))         ; green
   (blue        '("#31a9f3" "#31a9f3" "brightblue"))    ; bright-blue
   (dark-blue   '("#1da1f2" "#1da1f2" "blue"))          ; blue
   (cyan        '("#42d5f3" "#42d5f3" "brightcyan"))    ; bright-aqua
   (my-black    '("#4c515a" "#4c515a" "black"))
   (dark-cyan   '("#30d1f2" "#30d1f2" "cyan"))          ; aqua
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if doom-iro-brighter-comments magenta grey))
   (doc-comments   (if doom-iro-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       red)
   (methods        green)
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-iro-padded-modeline
      (if (integerp doom-iro-padded-modeline)
          doom-iro-padded-modeline
        4)))
   (modeline-bg bg-alt2)
